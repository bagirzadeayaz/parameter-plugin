...
const CUSTOMER_LANGUAGE_INSTRUCTIONS = ' Write all customer-facing opening messages, progress updates, choices, questions, errors, summaries, and PDF-facing explanatory prose only in Azerbaijani, regardless of the user request language. Preserve product names, model codes, units, website names, source links, exact quotations, and normalized parameter values.';
